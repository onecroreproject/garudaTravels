...
export const metadata = {
  title: "Garuda Tours & Travels | Contact Us Chennai",
  description:
    "Get in touch with Garuda Tours & Travels in Chennai for Tirupati and temple tour bookings, enquiries, phone, email and office address with hours of operation.",
};
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <Card>
                      ...
                      <CardContent className="space-y-2">
                        <a href="tel:+919840789844" className="block text-blue-600 hover:underline">+91 9840789844</a>
                        <a href="tel:+919840789857" className="block text-blue-600 hover:underline">+91 9840789857</a>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=garudattd1@gmail.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline block">garudattd1@gmail.com</a>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <a href="https://maps.google.com/?q=No.83,+Nehru+Nagar,+1st+Street,+13th+Main+Road,+Anna+Nagar+West,+Chennai" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline block">
                          <p>No.83, Nehru Nagar, 1st Street,</p>
                          <p>13th Main Road,</p>
