                    ...
                    <div className="p-4">
                      ...
                      <div className="border border-gray-200 rounded overflow-hidden">
                        {car.prices.map((price, priceIndex) => (
                          <div
                            key={price.value}
                            className={`grid grid-cols-2 py-3 px-4 border-b border-gray-200 last:border-0 ${
                              priceIndex % 2 === 0 ? "bg-gray-50" : "bg-white"
                            }`}
                          >
                              ...
                              section.listInfo.length > 0 && (
                                <div className="grid grid-cols-2 gap-4">
                                  {section.listInfo.map((item, itemIndex) => (
                                    <div
                                      key={item.id}
                                      className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-green-200 group hover:shadow-xl transition-all duration-300"
                                    >
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {otherPackages.map((pkg) => (
                  <Card
                    key={pkg.id}
                    className="overflow-hidden flex flex-col h-96"
                  >
                    <CardHeader className="p-0 flex-shrink-0">
                      <div className="relative w-full h-48">
                        <Image
                          src={
                            pkg.images?.[0] ||
                            "/images/city/free.png?height=200&width=300&query=other package image"
                          }
                          alt={pkg.title}
                          fill
                          style={{ objectFit: "cover" }}
