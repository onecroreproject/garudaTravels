    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="pt-16 md:pt-20 lg:pt-24">
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-6xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
                {/* Header Section */}
                <div className="text-center py-8 px-4 sm:py-12 sm:px-8 bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-indigo-600/5">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent leading-tight mb-6">
              ...
              <div className="quote-card relative">
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
                  ...
                  <div className="text-center space-y-4">
                    <blockquote className="text-base sm:text-lg text-gray-700 font-medium leading-relaxed italic">
        ...
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-br from-white via-blue-50 to-indigo-50 relative overflow-hidden">
          ...
          <div className="absolute top-20 right-20 w-32 md:w-40 h-32 md:h-40 bg-gradient-to-r from-blue-200/20 to-purple-200/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 left-20 w-48 md:w-60 h-48 md:h-60 bg-gradient-to-r from-indigo-200/20 to-blue-200/20 rounded-full blur-3xl"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="w-full order-1 lg:order-2">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl transform md:rotate-3"></div>
                  <div className="relative bg-white rounded-2xl shadow-2xl p-3 sm:p-4 transform md:-rotate-1 hover:md:rotate-0 transition-transform duration-500">
                    <Image
        ...
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute top-0 right-0 w-64 md:w-96 h-64 md:h-96 bg-gradient-to-l from-orange-200/30 to-red-200/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-56 md:w-80 h-56 md:h-80 bg-gradient-to-r from-pink-200/30 to-orange-200/30 rounded-full blur-3xl"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="w-full order-1">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-2xl transform md:rotate-6 group-hover:md:rotate-12 transition-transform duration-500"></div>
                  <div className="relative bg-white rounded-2xl shadow-2xl p-3 sm:p-6 transform md:-rotate-2 group-hover:md:rotate-0 transition-transform duration-500">
                    <Image
                      src="/images/6.png"
        ...
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 relative overflow-hidden">
          {/* Background Elements */}
        ...
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute top-0 right-0 w-64 md:w-96 h-64 md:h-96 bg-gradient-to-l from-purple-200/30 to-indigo-200/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-56 md:w-80 h-56 md:h-80 bg-gradient-to-r from-blue-200/30 to-purple-200/30 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="w-full order-1">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-2xl transform md:rotate-6 group-hover:md:rotate-12 transition-transform duration-500"></div>
                  <div className="relative bg-white rounded-2xl shadow-2xl p-3 sm:p-6 transform md:-rotate-2 group-hover:md:rotate-0 transition-transform duration-500">
                    <Image
                      src="/images/5.png"
              ...
              <div className="space-y-8 order-2">
                <div className="space-y-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent leading-tight">
                    Chennai to Tirupati <span className="text-purple-600">Outstation Car Rental Package</span>
                  </h2>
        ...
        <section className="py-12 sm:py-20 px-4 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute top-0 left-0 w-64 md:w-96 h-64 md:h-96 bg-gradient-to-r from-amber-200/30 to-yellow-200/30 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-56 md:w-80 h-56 md:h-80 bg-gradient-to-l from-orange-200/30 to-amber-200/30 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="w-full order-1 lg:order-2">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-2xl transform md:-rotate-6 group-hover:md:-rotate-12 transition-transform duration-500"></div>
                  <div className="relative bg-white rounded-2xl shadow-2xl p-3 sm:p-6 transform md:rotate-2 group-hover:md:rotate-0 transition-transform duration-500">
                    <Image
                      src="/images/1.webp"
